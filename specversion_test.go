...
func TestSpecVersion_String(t *testing.T) {
	...
	assert.Equal("1.0", SpecVersion1_0.String(), "SpecVersion1_0 should be '1.0.0'")
	assert.Equal("1.1", SpecVersion1_1.String(), "SpecVersion1_1 should be '1.1.0'")
	assert.Equal("1.2", SpecVersion1_2.String(), "SpecVersion1_2 should be '1.2.0'")
	assert.Equal("1.3", SpecVersion1_3.String(), "SpecVersion1_3 should be '1.3.0'")
	assert.Equal("1.4", SpecVersion1_4.String(), "SpecVersion1_4 should be '1.4.0'")
	assert.Equal("1.5", SpecVersion1_5.String(), "SpecVersion1_5 should be '1.5.0'")
	assert.Equal("1.6", SpecVersion1_6.String(), "SpecVersion1_6 should be '1.6.0'")
}
